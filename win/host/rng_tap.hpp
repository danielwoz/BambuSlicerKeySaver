...
// request (encAppKey + aes256) and the create_task signature -- WITHOUT touching
// the VMProtect-virtualized logic, because BCryptGenRandom is a clean dynamic
// import that executes as ordinary Windows code the VM merely CALLs out to.
//
